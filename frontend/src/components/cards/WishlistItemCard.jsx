    ...
    <div className="bg-white rounded-2xl shadow-sm p-3 w-full max-w-[500px]">
      <div className="relative mb-2">
        ...
        <button
          ...
          className="absolute top-2 right-2 text-[13px] shadow-sm font-medium bg-red-50 text-red-500 border border-red-200 rounded-full px-3 py-1 hover:bg-red-100 transition"
        >
          Remove
        </button>
      </div>
      ...
      <h2 className="font-semibold text-[16px] flex items-center gap-2">
        {item.title}
        <span className="text-xs px-1 bg-purple-100 text-purple-700 rounded-md border truncate">
          {item.category}
        </span>
      </h2>
      ...
      <button
        ...
        className={`w-full text-white text-[13px] py-2 rounded-full flex items-center justify-center gap-2 transition
    ${
