            ...
            <div className="max-w-6xl mx-auto flex flex-wrap justify-between gap-10">
                ...
                <div>
                    ...
                    <ul className="text-xs text-gray-300 space-y-4">
                        <li><a href="/#" className="hover:text-[#e3c6ff] transition-colors duration-200">My Account</a></li>
                        <li><a href="/#" className="hover:text-[#e3c6ff] transition-colors duration-200">Login / Register</a></li>
                        <li><a href="/#" className="hover:text-[#e3c6ff] transition-colors duration-200">Cart</a></li>
                        <li><a href="/#" className="hover:text-[#e3c6ff] transition-colors duration-200">Wishlist</a></li>
                        <li><a href="/#" className="hover:text-[#e3c6ff] transition-colors duration-200">Shop</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="text-xs text-gray-300 space-y-4">
                        <li><a href="/#" className="hover:text-[#e3c6ff] transition-colors duration-200">Privacy Policy</a></li>
                        <li><a href="/#" className="hover:text-[#e3c6ff] transition-colors duration-200">Terms Of Use</a></li>
                        <li><a href="/#" className="hover:text-[#e3c6ff] transition-colors duration-200">FAQ</a></li>
                        <li><a href="/#" className="hover:text-[#e3c6ff] transition-colors duration-200">Contact</a></li>
                    </ul>
                </div>
