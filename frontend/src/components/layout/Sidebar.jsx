...
const DashboardIconActive = "/assets/icons/dashboard1.png";
const ListingsIcon = "/assets/icons/listing.png";
const ListingsIconActive = "/assets/icons/listing1.png";
const BookingsIcon = "/assets/icons/bookings.png";
const BookingsIconActive = "/assets/icons/bookings1.png";
...
const items = [
  ...
  { 
    label: "Bookings", 
    icon: BookingsIcon,
    iconActive: BookingsIconActive,
    path: "/owner/bookings"
  },
  { 
    label: "Earnings", 
    icon: EarningsIcon,
    iconActive: EarningsIcon, // No "active" variant
    path: "/owner/earnings"
  },
  { 
    label: "Profile", 
