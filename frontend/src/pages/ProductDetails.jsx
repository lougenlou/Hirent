...
const OwnerSection = ({ owner, onReport }) => {
  ...
  return (
    <div className="bg-gradient-to-r from-gray-50 to-gray-100/50 py-6">
      <div className="px-4 sm:px-6 lg:pl-32 lg:pr-6">
        <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm max-w-4xl">
          <div className="flex flex-col md:flex-row md:items-center gap-5">
            ...
            <div className="flex items-center gap-4 flex-1 min-w-0">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2 flex-wrap">
                  <h4 className="text-base font-bold text-gray-900 truncate">{owner.name}</h4>
                  {owner.verified && (
            ...
            <div className="flex items-center gap-4 md:gap-6 py-3 md:py-0 md:px-6 md:border-l border-gray-100">
              <div className="text-center">
                <p className="text-lg font-bold text-gray-900">{owner.totalListings}</p>
                <p className="text-xs text-gray-500">Listings</p>
              </div>
              <div className="text-center">
                <p className="text-lg font-bold text-gray-900">{owner.totalRentals}</p>
                <p className="text-xs text-gray-500">Rentals</p>
              </div>
              <div className="text-center">
                <p className="text-lg font-bold text-emerald-600">{owner.responseRate}%</p>
        ...
        <div className="px-4 sm:px-6 lg:pl-32 lg:pr-6 py-4">
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div className="flex items-center flex-wrap gap-x-2 gap-y-1 text-sm">
              ...
              <span className="text-gray-300">/</span>
              <a href="/categories" className="text-gray-400 hover:text-[#7A1CA9] transition">Categories</a>
              <span className="text-gray-300">/</span>
              <a href="/gadgets" className="text-gray-400 hover:text-[#7A1CA9] transition">Gadgets</a>
              <span className="text-gray-300">/</span>
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 text-gray-500 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all text-sm"
            >
              <Flag size={14} />
