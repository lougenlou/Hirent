...
const OwnerLogin = () => {
  ...
  useEffect(() => {
    if (location.state?.error) {
      ...
      // Clear state so error does not persist
 ...
 const handleGoogleLogin = () => {
  const from = "/ownerlogin";
  window.location.href = `http://localhost:5000/api/auth/google/owner?from=${encodeURIComponent(
    from
  )}`;
};
        ...
        <div className="z-10 cursor-default bg-white w-[460px] h-[560px] rounded-2xl shadow-2xl flex flex-row overflow-hidden hover:shadow-2xl hover:scale-[1.01] transition-all duration-300">
          <div className="flex flex-col justify-center items-center w-full p-5">
            ...
            <div className="w-full flex flex-col items-start ml-14">
              ...
              <h2 className="text-[23px] font-bold text-gray-900">Log In</h2>
            ...
            <div className="w-full flex gap-3 text-[12px] text-gray-500 mt-4 justify-center">
