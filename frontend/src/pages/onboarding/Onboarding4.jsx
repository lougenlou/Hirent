...
const Onboarding = () => {
    ...
    return (
        ...
        <div className="onboarding-content">
                    ...
                    {/* Heading & Paragraph */}
                    <h3 className="text-[24px] text-gray-800 mt-10 mb-0 text-center whitespace-nowrap max-w-none">
                        Welcome,
                    </h3>
                    <h2 className="text-[32px] font-bold text-gray-900 mb-10 text-center whitespace-nowrap max-w-none">
                        Genlou Bandin!
                    </h2>

                    {/* Next Button */}
                    <div className="flex justify-center w-[390px] mt-6 relative">
                        <button
                            type="submit"
                            onClick={handleNext}
    ...
    src={arrow}
    alt="Arrow"
    className="absolute top-[calc(50%+70px)] left-[calc(50%+210px)] w-[150px] h-[150px] object-contain z-10"
/>
